...
namespace GameMVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation", new GameMVC.ViewModels.ExternalLoginConfirmationViewModel { Email = loginInfo.Email });
            }
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> ExternalLoginConfirmation(GameMVC.ViewModels.ExternalLoginConfirmationViewModel model, string returnUrl)
        {
